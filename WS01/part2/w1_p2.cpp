...
<Order Tag>,<Customer Name>,<Order Description>,<Price_value>,<Daily Special Status>
...
int main(int argc, char *argv[])
{
	...
	for (auto day = 1; day < argc; ++day)
	{
		...
		std::cout << "    Day " << day << '\n';
		std::cout << "--------------------\n";
		std::cout << "Name          |Order Description        |Price_value w/Tax |Special Price_value" << std::endl;
